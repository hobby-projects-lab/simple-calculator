...
val materialSymbolsCreditCardHeart = IconClass(
    MaterialSymbolsCreditCardHeart.name,
    MaterialSymbolsCreditCardHeart,
    "https://composables.com/icons/icon-libraries/material-symbols/credit_card_heart",
    """Apache License
                           Version 2.0, January 2004
                        http://www.apache.org/licenses/
...
private val MaterialSymbolsCreditCardHeart: ImageVector
    get() {
        if (_MaterialSymbolsCreditCardHeart != null) return _MaterialSymbolsCreditCardHeart!!

        _MaterialSymbolsCreditCardHeart = ImageVector.Builder(
        ...
        return _MaterialSymbolsCreditCardHeart!!
    }

private var _MaterialSymbolsCreditCardHeart: ImageVector? = null